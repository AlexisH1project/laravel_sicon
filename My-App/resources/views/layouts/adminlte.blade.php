...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-dark" style="background: rgb(146, 25, 40)">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('General.guardarVista')}}" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="{{route('DDSCH.guardarVistaEventuales')}}" class="nav-link">
                  <i class="fas fa-arrow-circle-up"></i>
                  <p>Guardar Documentos Eventuales</p>
                </a>
              </li>
            </ul>
          </li>
